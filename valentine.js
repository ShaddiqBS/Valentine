let messages = ["Serius?", "Beneran ni?", "Eeee yakinn?", "Pikirin dulu dehh", "Salah pencet kalii", "yang benerr?", "Benerann kah maniss?", "Terakhir deh"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        <img src="bubu-dudu-sseeyall.gif " class="gif">
        <div class="question">YEYYYYY LOVE YOU SOO MUCHHH DHIAAA❤️</div>
    `;
    launchConfetti();
    startHeartRain();
}
